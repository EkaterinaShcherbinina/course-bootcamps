...
public class ChoresArrayImpl<E> implements ChoresCollectionInterface<E> {
    ...
    public E remove(int i) {
        ...
        if (i <= num_elements) {
            ...
            if(num_elements > 0 && num_elements == elements.length / 4) resize(elements.length / 2);
    ...
    private boolean resize(int capacity) {
        ...
        System.out.println("Capacity reached. Resizing storage...");
    ...
    public ChoresArrayImpl<E> subList(int from, int to) {
        ChoresArrayImpl<E> sublist = new ChoresArrayImpl<>();
    ...
    private class ChoresArrayIterator implements Iterator<E>{
        private int i = 0;
    ...
    public Iterator<E> iterator() {
        return new ChoresArrayIterator();
    }
}
